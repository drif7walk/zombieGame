...
Magazine::Magazine(std::shared_ptr< Sprite > templatesprite): Sprite(templatesprite)  
{
	this->bulletCount = 30;
...
Magazine::Magazine(std::string filename, std::shared_ptr< SDL_Renderer > ren): Sprite(filename, ren)
{

}

void Magazine::Update(double deltaTime, std::shared_ptr<UI> ui,
