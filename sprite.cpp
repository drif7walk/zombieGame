...
void Sprite::Render(boost::shared_ptr< SDL_Renderer > ren)
{
...
void Sprite::Render(boost::shared_ptr< SDL_Renderer > ren, Vector offset)
{
...
void Sprite::Update(double deltaTime, boost::shared_ptr<UI> ui,
...
Sprite::Sprite(boost::shared_ptr< Sprite > templatesprite)
{
...
Sprite::Sprite(std::string filename, boost::shared_ptr< SDL_Renderer > ren)
{
	this->texture = NULL;
